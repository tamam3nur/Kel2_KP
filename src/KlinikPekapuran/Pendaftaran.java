...
public class Pendaftaran extends javax.swing.JInternalFrame {
    ...
    public void lebarKolom(){
        TableColumn kolom;
        tabelPasien.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        ...
        kolom.setPreferredWidth(100);
        kolom = tabelPasien.getColumnModel().getColumn(4);
        kolom.setPreferredWidth(100);
    ...
    private void initComponents() {
        ...
        tgl_lahir_pasien.setPreferredSize(new java.awt.Dimension(6, 27));
        ...
        jLabel10.setText("D a t a b a s e   P a s i e n");
    ...
    private void pencarianKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pencarianKeyPressed
        ...
        String sql="Select * from pasien where id_pasien like '%" + pencarian.getText() + "%'" +"or nama_pasien like '%" + pencarian.getText()+"%'";
        try {
            java.sql.Statement put = Conn.createStatement();
            ResultSet hasil = put.executeQuery(sql);
            while (hasil.next()){
